# PRD-42: Your First App (202397)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_202397_v672423.zip`
...
- Build for: **freshdesk**
- Core features: This app displays the name of the requester of a freshdesk ticket in the ticket_sidebar placeholder │   ├── index.html            A landing page for the user to use the app
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 202397 (Your First App). Implement: This app displays the name of the requester of a freshdesk ticket in the ticket_sidebar placeholder │   ├── index.html            A landing page for the user to use the app. Keep folder structure compatible with: app, config. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshdesk:location(new_email_background, ticket_background, ticket_conversation_editor); freshdesk:requests(getEmailConfigs, getGroups, getProducts, getTicketFields)
