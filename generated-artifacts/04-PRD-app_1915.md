# PRD-04: Freshdesk App Project (1915)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_1915_v116852.zip`
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 1915 (Freshdesk App Project). Implement: Congratulations on creating your App Project! Feel free to replace this text with your project description. │   ├── iparams.json           Installation parameter config in English language.. Keep folder structure compatible with: config, server. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
