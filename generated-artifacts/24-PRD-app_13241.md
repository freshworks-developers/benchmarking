# PRD-24: Your First App (13241)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_13241_v688594.zip`

---

## 1. Summary

This app targets **Modules: common, service_change, service_ticket** and is generated from packaged app metadata. The implementation should deliver the core behavior inferred from the app package while following Freshworks Platform 3.0 constraints.
...
- Build for: **Modules: common, service_change, service_ticket**
...
Build a Freshworks Platform 3.0 app for Modules: common, service_change, service_ticket based on app 13241 (Your First App). Implement: Congratulations on creating your first app! Feel free to replace this text with your app's actual description. │   ├── app.js                 JS to render the dynamic portions of the app. Keep folder structure compatible with: app, config. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
