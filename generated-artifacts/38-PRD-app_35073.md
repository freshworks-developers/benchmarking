# PRD-38: Clone Ticket (35073)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_35073_v432403.zip`
...
- Build for: **freshdesk**
- Core features: FreshDesk marketplace app to clone a ticket https://www.freshworks.com/apps/freshdesk/clone_ticket_1
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 35073 (Clone Ticket). Implement: FreshDesk marketplace app to clone a ticket https://www.freshworks.com/apps/freshdesk/clone_ticket_1. Keep folder structure compatible with: app, config, server. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshdesk:location(ticket_sidebar); freshdesk:requests(addNote, createTicket, getTicket); freshdesk:functions(addAttachments, addLog)
