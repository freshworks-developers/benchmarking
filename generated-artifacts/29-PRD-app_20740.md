# PRD-29: Your First App (20740)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_20740_v120406.zip`

---

## 1. Summary

This app targets **freshcaller** and is generated from packaged app metadata. The implementation should deliver the core behavior inferred from the app package while following Freshworks Platform 3.0 constraints.
...
- Build for: **freshcaller**
- Core features: Congratulations on creating your first app! Feel free to replace this text with your app's actual description. │   ├── app.js                 JS to render the dynamic portions of the app
...
Build a Freshworks Platform 3.0 app for freshcaller based on app 20740 (Your First App). Implement: Congratulations on creating your first app! Feel free to replace this text with your app's actual description. │   ├── app.js                 JS to render the dynamic portions of the app. Keep folder structure compatible with: app, config. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshcaller:location(conversation_card, notification_card, widget_conversation_card, widget_notification_card); whitelisted-domains
