...
**Source package:** `app_13306_v692218.zip`
...
- Core features: Congratulations on creating your Kabana! Feel free to replace this text with your app's actual description. │   ├── app.js                 JS to render the dynamic portions of the app
...
Build a Freshworks Platform 3.0 app for Modules: common, support_ticket based on app 13306 (Kabana). Implement: Congratulations on creating your Kabana! Feel free to replace this text with your app's actual description. │   ├── app.js                 JS to render the dynamic portions of the app. Keep folder structure compatible with: app, config, server. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
