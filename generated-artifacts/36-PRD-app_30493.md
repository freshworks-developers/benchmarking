# PRD-36: App 30493 (30493)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_30493_v248732.zip`

---

## 1. Summary

This app targets **Freshworks Platform** and is generated from packaged app metadata. The implementation should deliver the core behavior inferred from the app package while following Freshworks Platform 3.0 constraints.
...
- Build for: **Freshworks Platform**
- Core features: Freshworks custom app behavior inferred from packaged app structure.
- Respect expected app structure: `app, config, server, src`
...
Build a Freshworks Platform 3.0 app for Freshworks Platform based on app 30493 (App 30493). Implement: Freshworks custom app behavior inferred from packaged app structure.. Keep folder structure compatible with: app, config, server, src. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
