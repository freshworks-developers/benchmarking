# PRD-40: Bulk Ticket Manager Light (45061)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_45061_v160650.zip`
...
- Build for: **freshdesk**
- Core features: Implements Freshworks app capabilities using: freshdesk:location(full_page_app); whitelisted-domains
- Respect expected app structure: `app, config, src`
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 45061 (Bulk Ticket Manager Light). Implement: Implements Freshworks app capabilities using: freshdesk:location(full_page_app); whitelisted-domains. Keep folder structure compatible with: app, config, src. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshdesk:location(full_page_app); whitelisted-domains
