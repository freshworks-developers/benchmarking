# PRD-12: App 4239 (4239)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_4239_v3992.zip`
...
- Build for: **freshdesk**
- Core features: Implements Freshworks app capabilities using: freshdesk:location(ticket_conversation_editor)
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 4239 (App 4239). Implement: Implements Freshworks app capabilities using: freshdesk:location(ticket_conversation_editor). Keep folder structure compatible with: app, config. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshdesk:location(ticket_conversation_editor)
