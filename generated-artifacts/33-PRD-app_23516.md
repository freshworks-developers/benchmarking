# PRD-33: Your First App (23516)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_23516_v291542.zip`

---

## 1. Summary

This app targets **freshchat** and is generated from packaged app metadata. The implementation should deliver the core behavior inferred from the app package while following Freshworks Platform 3.0 constraints.
...
- Platform features observed: freshchat:location(conversation_user_info); freshchat:requests(requestTemplateAU, requestTemplateEU, requestTemplateIN, requestTemplateUS)
