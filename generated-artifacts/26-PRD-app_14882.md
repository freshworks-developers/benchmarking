# PRD-26: Teamviewer (14882)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_14882_v140978.zip`
...
- Build for: **freshchat**
- Core features: We are updating the exsisting app as from Teamviewer side in for OAUTH authorization options field added and that is mandatory.
...
Build a Freshworks Platform 3.0 app for freshchat based on app 14882 (Teamviewer). Implement: We are updating the exsisting app as from Teamviewer side in for OAUTH authorization options field added and that is mandatory.. Keep folder structure compatible with: app, config. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshchat:location(conversation_user_info); whitelisted-domains
