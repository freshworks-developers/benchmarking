# PRD-09: App 3385 (3385)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_3385_v145212.zip`
...
- Build for: **freshdesk**
- Core features: Implements Freshworks app capabilities using: freshdesk:location(ticket_sidebar); whitelisted-domains
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 3385 (App 3385). Implement: Implements Freshworks app capabilities using: freshdesk:location(ticket_sidebar); whitelisted-domains. Keep folder structure compatible with: app, config. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshdesk:location(ticket_sidebar); whitelisted-domains
