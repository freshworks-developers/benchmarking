# PRD-19: App 9822 (9822)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_9822_v686029.zip`
...
- Build for: **freshdesk**
- Core features: Implements Freshworks app capabilities using: freshdesk:location(new_email_background, new_ticket_background, ticket_background); freshdesk:requests(getAdminTicketFields, getTicketFields, getUserRoles)
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 9822 (App 9822). Implement: Implements Freshworks app capabilities using: freshdesk:location(new_email_background, new_ticket_background, ticket_background); freshdesk:requests(getAdminTicketFields, getTicketFields, getUserRoles). Keep folder structure compatible with: app, config. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshdesk:location(new_email_background, new_ticket_background, ticket_background); freshdesk:requests(getAdminTicketFields, getTicketFields, getUserRoles)
