# PRD-07: App 2634 (2634)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_2634_v7381.zip`
...
- Build for: **freshdesk**
- Core features: Implements Freshworks app capabilities using: freshdesk:location(ticket_background); whitelisted-domains
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 2634 (App 2634). Implement: Implements Freshworks app capabilities using: freshdesk:location(ticket_background); whitelisted-domains. Keep folder structure compatible with: app, config. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshdesk:location(ticket_background); whitelisted-domains
