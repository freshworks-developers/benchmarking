# PRD-03: Hubspot Latest App 2020 Dec 11 (1844)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_1844_v618481.zip`
...
- Core features: App timeline templates changed to display correct date.
...
Build a Freshworks Platform 3.0 app for Modules: common, support_ticket based on app 1844 (Hubspot Latest App 2020 Dec 11). Implement: App timeline templates changed to display correct date.. Keep folder structure compatible with: app, config, server. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
