# PRD-05: App 1996 (1996)

**Version:** 1.0  
**Status:** Draft for benchmark review  
**Source package:** `app_1996_v162374.zip`
...
- Build for: **freshdesk**
- Core features: Implements Freshworks app capabilities using: freshdesk:location(ticket_background, ticket_sidebar); freshdesk:events(onConversationCreate, onTicketCreate); whitelisted-domains
...
Build a Freshworks Platform 3.0 app for freshdesk based on app 1996 (App 1996). Implement: Implements Freshworks app capabilities using: freshdesk:location(ticket_background, ticket_sidebar); freshdesk:events(onConversationCreate, onTicketCreate); whitelisted-domains. Keep folder structure compatible with: app, config, server. Include robust error handling, idempotent side effects for event flows, and validation-safe configuration.
...
- Platform features observed: freshdesk:location(ticket_background, ticket_sidebar); freshdesk:events(onConversationCreate, onTicketCreate); whitelisted-domains
